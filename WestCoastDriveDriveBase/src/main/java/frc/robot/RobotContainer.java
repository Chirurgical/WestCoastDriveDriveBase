...
public class RobotContainer {
  ...
  //Creating objects for each subsystem and commands to use them in other files.
  private final DriveBase m_driveBase = new DriveBase();
  private final ControllerDrive m_controllerDrive = new ControllerDrive(m_driveBase);
